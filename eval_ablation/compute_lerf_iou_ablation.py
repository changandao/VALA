...
def evalute(gt_base, pred_base, output_dir=None, eval_args=None):
    ...
    if output_dir is not None:
        ...
        log_file_path = os.path.join(output_dir, "result_3d.txt")
...
if __name__ == "__main__":
    ...
    if args.scene_name:
        ...
        path_pred = os.path.join(args.pred_dir, args.scene_name, args.ablation_type, 'predictions')
    ...
    results_path = os.path.join(args.output_dir, f'{args.ablation_type}_all_metrics_{args.iteration}_{args.mask_thresh}.json')
